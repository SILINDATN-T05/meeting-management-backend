...
responseParser.parseResult =   function(xml_escape, mapper, callback){
    //convert escaped to unescaped xml
    var xml = unescape(xml_escape);
    //convert xml to json and map the results to response mapper
